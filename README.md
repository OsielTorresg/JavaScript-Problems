...
## Problems with number types

- [containsDigits.js](./numbers/containsDigits/containsDigits.js)
- [createArrayOfRand.js](./numbers/createArrayOfRand/createArrayOfRand.js)
- [evenNumbers.js](./numbers/evenNumbers/evenNumbers.js)
- [largestNumbers.js](./numbers/largestNumbers/largestNumber.js)
- [oddNumbers.js](./numbers/oddNumbers/oddNumbers.js)
